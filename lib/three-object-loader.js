...
// Original source: https://github.com/sohamkamani/three-object-loader/blob/master/source/index.js
// Modified to return the state with the vertices
      ...
      for (var i = 0, l = lines.length; i < l; i++) {
        ...
        if (lineFirstChar === 'v') {
          ...
          if ((result = this.regexp.face_vertex_uv_normal.exec(line)) !== null) {
            ...
            state.addFace(
              // NOTE: Modified to associate normals with the faces
